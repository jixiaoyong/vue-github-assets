...
<template>
    <div class="vga-grid-container">
        ...
        <div v-else class="vga-grid vga-root">
            <div v-for="item in items" :key="item.sha" class="vga-grid-item" :class="{
            ...
            <div v-if="selectedItem" class="vga-toolbar">
                <div class="vga-toolbar__content">
                    ...
                    <div class="vga-toolbar__actions">
                        ...
                        <!-- Delete button -->
                        <button class="vga-toolbar__btn vga-toolbar__btn--danger" @click="handleDelete"
                            title="删除 / Delete">
                            <Trash2 :size="18" />
                        </button>
        ...
        <Teleport to="body">
            <Transition name="toast">
                <div v-if="toastMessage" class="vga-toast">
                    <Check :size="16" />
